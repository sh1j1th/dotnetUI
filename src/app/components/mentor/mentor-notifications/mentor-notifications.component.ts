...
tableData;
  ...
  getNotifications = function () {
    this.http.get("https://localhost:9075/mentorservice/mentorNotifications/"+this.mentorEmail).subscribe(
      (result: any[]) => {
  ...
  approveRequest(registrationId: number, isApproved: boolean){
    ...
    this.http.put("https://localhost:9075/mentorservice/courseRequestUpdate/"+registrationId,
